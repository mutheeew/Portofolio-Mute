...
export default function ProfileSection() {
    return (
        <div className="min-h-screen bg-gradient-to-t from-blue-100 via-blue-50 to-white relative overflow-hidden w-full max-w-full">
            <div 
            ...
            <div className="relative flex flex-col items-center px-6 pt-12 pb-16 gap-6 md:hidden">
                ...
                <a
                    href="https://wa.me/6285189989891"
                    target="_blank"
            ...
            <div className="relative min-h-screen hidden md:flex items-center mx-auto px-4 sm:px-8 py-8">
