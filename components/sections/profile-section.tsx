...
export default function ProfileSection() {
    return (
        <div className="h-screen bg-gradient-to-t from-blue-100 via-blue-50 to-white relative overflow-hidden">
            ...
            <div className="relative h-full flex items-center mx-auto px-8">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center w-full">
                
                {/* Left Column - Name & Introduction */}
                <div className="lg:col-span-4 flex flex-col justify-between h-full py-20">
                    {/* Main Heading */}
                    <div>
                ...
                {/* Center Column - Image */}
                <div className="lg:col-span-4 flex justify-center items-end h-full pb-0">
                    <div className="relative w-full max-w-md mb-0">
                        {/* Profile Image */}
